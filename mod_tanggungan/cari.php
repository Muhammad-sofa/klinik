...
<table class="table table-striped">
					...
					<tbody>
					<?php					
					$query=mysql_query("SELECT * FROM tanggungan, pegawai_kel, pegawai WHERE tanggungan.id_kpeg=pegawai_kel.id_kpeg AND pegawai_kel.nip_pegawai=pegawai.nip AND pegawai_kel.nama_kpeg LIKE '%".$kodepasien."%' OR tanggungan.id_kpeg=pegawai_kel.id_kpeg AND pegawai_kel.nip_pegawai=pegawai.nip AND pegawai.nama_pegawai LIKE '%".$kodepasien."%'");
					$no=1;
